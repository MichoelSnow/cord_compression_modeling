...
def run():
    ...
    train_gen = set_dir_flow_generator(dir='/data/gferguso/cord_comp/cv_unit_test/images/train', image_size=image_size)
    test_gen = set_dir_flow_generator(dir='/data/gferguso/cord_comp/cv_unit_test/images/test', image_size=image_size)

    ####### SimpleCNN
    print('Fitting Simple CNN')
    # Add a model
