...
@gin.configurable
def set_gen(featurewise_center=False, samplewise_center=False, featurewise_std_normalization=False,
            ...
            rescale=1./255, preprocessing_function=None, data_format=None, validation_split=0.0):
    datagen = keras.preprocessing.image.ImageDataGenerator(featurewise_center=featurewise_center,
